...
?></span>
          ...
          <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-md-8 mb-3 mb-md-0">
                <input id="af" type="text" class="form-control py-3" id="coupon" placeholder="Coupon Code">
              </div>
              <div class="col-md-4">
                <button  id="co" class="btn btn-primary btn-md px-4">Apply Coupon</button>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">$<?php echo $GLOBALS['sum']; ?></strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
  ...
  <script>	$('#co').one('click', function(){
		$('#af').after("<span style='color:red;'>Invalid Coupon code!</span>");
	});
</script>
