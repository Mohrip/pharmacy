...
function fetchBlogArticleHome(){

    $search1 = $_POST['Search1'];
    include 'db_conn.php';
    $query = mySQLi_query($conn, "SELECT * FROM medicine WHERE name LIKE '%$search1%'");
    while ($row = mySQLi_fetch_array($query)) {
        ...
        <div class="col-sm-6 col-lg-4 text-center item mb-4" style="position:relative; top:60px;">
            ...
            <h3 class="text-dark"> <a href="shop-single.php" style="position:relative; top:40px;">"' . $row['name'] . '"</a></h3>
            <p class="price" style="position:relative; top:40px;"><del>95.00</del> &mdash; ' . $row['price'] . '</p> 
        </div>
        ...
        <div class="col-sm-6 col-lg-4 text-center item mb-4">
            ...
            <p class="price"><del>95.00</del> &mdash; ' . $row['price'] . '</p> 
        </div>
      ...
      <div class="search-wrap">
        <div class="container">
          ...
          <form action="forSearch.php" method="post">
            <input type="text" name="Search1"class="form-control" placeholder="Search keyword and hit enter...">
          </form>
        </div>
      </div>
